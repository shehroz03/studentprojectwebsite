...
export const Layout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen mesh-gradient flex flex-col relative">
      ...
      >
        <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7 fill-current stroke-none">
        ...
        <span className="absolute right-full mr-4 bg-gray-900 text-white font-semibold text-xs px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
          Chat on WhatsApp
        </span>
      </a>
    </div>
